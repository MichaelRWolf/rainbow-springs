...
- **Barcode data string** — raw alphanumeric text embedded in the Code 128 barcode, e.g., `FLSP-987654321-X`
...
| barcode_data_string | Text         | Raw alphanumeric text for Code 128 barcode | FLSP-987654321-X           |
